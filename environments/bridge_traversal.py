...
class BridgeTraversalEnv(discrete.DiscreteEnv):
    """
    ...
    def __init__(self, wind_prob=0.1):
        ...
        self._cliff[0, 4:7] = True
        self._cliff[1, 4:7] = True
        self._cliff[3, 4:7] = True
        ...
        super(BridgeTraversalEnv, self).__init__(nS, nA, P, isd)
    ...
    def _calculate_transition_prob(self, current, delta, winds):
        ...
        if self._cliff[tuple(new_position)]:
            return [(1.0, self.start_state_index, -1000, False)]
    ...
    def new_instance(self):
        return BridgeTraversalEnv(wind_prob=self.wind_prob)
